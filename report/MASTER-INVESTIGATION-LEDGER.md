...
| ENV-002 | 2026-08-13 | A/C | What is the tsbx default policy? | read `tsbx_rules.json` | `default_action: deny_write`, `recyclebin_backup: true`, `auto_grant: true`; **no** `<WORKSPACE>\**` allow rule | PROVEN | CONFIRMED | `report/tsbx_rules.original.json`, `report/sanitized-evidence.md §C` | ENVIRONMENT-MODEL.md, BUG-B | — | ORIGINAL_LOCAL_SHA256 `30A07E5F…B9A45A` (verified 2026-08-15); PUBLIC_SANITIZED `121c8e05…8f8f2` (not byte-identical) |
